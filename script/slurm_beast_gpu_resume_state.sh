...
#SBATCH -A HSALJE-SL3-GPU
#! Output filenames: %A means slurm job ID
#SBATCH --output=xxxx_gpu_%A.log
#! Redirect error messages with: -e <file_name>
#SBATCH --error=xxxx_gpu_%A.err
...
#! This should be the path to whereever you installed BEAST
application="~/rds/hpc-work/BEASTv1.10.4/bin/beast"

#! Run options for the application:
options="-beagle_GPU -beagle_order 1 -prefix 2_ -load_state checkpoint.state -save_every nnn -save_state checkpoint_2.state -force_resume ~/xxxxfile.xml"
